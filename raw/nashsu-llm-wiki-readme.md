...
作者: nashsu
抓取日期: 2026-07-14
本文件由 LLM 经 WebFetch 抓取整理落盘，用户授权。
...
Not in the original. For LLMs that emit ` thinking` blocks (DeepSeek, QwQ, etc.):
...
- **Thinking display** — ` thinking` blocks shown as collapsible sections during synthesis, auto-scroll to latest content
